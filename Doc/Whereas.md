...
<details>
  <summary><strong>(30) This Regulation’s cybersecurity rules align with existing radio equipment rules, so standardisation work must be reused if Delegated Regulation 2022/30 changes, and the Commission should guide manufacturers that must comply with both during the transition.</strong></summary>
