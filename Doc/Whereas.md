...
<details>
  <summary><strong>(76) Manufacturers must set up coordinated vulnerability disclosure processes (and may use bug bounty programmes) so people can safely report flaws, giving them time to fix issues before details are made public.</strong></summary>
...
<details>
  <summary><strong>(78) Online marketplaces are only treated as economic operators when they also sell, distribute or fulfil digital products (then they must meet the matching duties)</strong> and should cooperate with market surveillance authorities to help ensure those products meet this Regulation’s cybersecurity rules.</summary>
